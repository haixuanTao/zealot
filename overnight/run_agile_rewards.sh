...
env NEXUS_SMALL_SORT=1 BIPED_CUTILE_GEMM=1 BIPED_CUDA=1 \
    BIPED_AGILE_REWARDS=1 BIPED_POWER_W=0 BIPED_LR_MIN=1e-5 BIPED_NORM_FREEZE=1 BIPED_GRAD_CLIP=1.0 \
    BIPED_AGILE_DR=1 BIPED_RESET_VEL=1 \
    ...
    BIPED_RESAMPLE_S=8,12 BIPED_VY=-0.5,0.5 BIPED_YAW=-1.0,1.0 \
